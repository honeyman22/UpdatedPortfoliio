import { websiteData } from "@/utils/usefuldata/website.data";import Image from "next/image";
  ...
  return (
    <div className="px-4 sm:px-10 py-6 flex flex-col  justify-center items-center">
      ...
      <p className="sm:w-[50%] text-center mt-2 ">
        Designing and developing high-performance, responsive, and user-friendly
        websites using modern technologies. From intuitive UI/UX to scalable
        backend solutions, I create web experiences that are visually appealing,
        functional, and optimized for speed, security, and seamless user

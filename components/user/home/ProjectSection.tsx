import { projectCategory } from "@/utils/deleteable/project-section";import ProjectCard from "./ProjectCard";
...
const ProjectSection = () => {
  return (
    ...
    >
      ...
      />{" "}
      <div className="project-card-wrapper grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
